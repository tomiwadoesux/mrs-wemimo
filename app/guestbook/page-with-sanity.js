        ...
        <section className="relative pt-32 pb-20 bg-primary overflow-hidden">
          <div className="container mx-auto px-6 relative">
            <div className="flex items-center gap-2 text-secondary mb-4">
              ...
              <span className="text-sm uppercase tracking-wider">Memories of Pastor Bayo</span>
            </div>
            ...
            <p className="text-primary-foreground/70 text-xl max-w-2xl">
              Heartfelt words from those whose lives were touched by Pastor Bayo.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-2xl mx-auto">
              <div className="text-center mb-12">
                <p className="text-secondary text-sm uppercase tracking-[0.2em] mb-4">Memories Live On</p>
                <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-4 text-balance">
                  Share a Memory of Pastor Bayo
                </h2>
                <p className="text-muted-foreground">Your words help keep his memory alive for future generations.</p>
              </div>
              <TestimonialForm />
            </div>
          </div>
            ...
            <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
              {testimonials.map((testimonial: any) => (
                ...
                >
                  ...
                  <p className="text-foreground leading-relaxed mb-6 text-lg">{testimonial.message}</p>
                  <div className="pt-5 border-t border-border/50">
                    <p className="font-semibold text-foreground mb-3">{testimonial.name}</p>
